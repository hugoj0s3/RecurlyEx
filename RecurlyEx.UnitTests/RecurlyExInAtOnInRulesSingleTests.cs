...
public class RecurlyExInAtOnInRulesSingleTests
{
    [Theory]
    [InlineData("@in day 5")]
    ...
    public void TryParse_InDay5_Success(string expression)
    {
        ...
        var dayRule = recurlyEx.DayRules().FirstOrDefault() as RecurlyExAtInOnRule;
        dayRule.Should().NotBeNull();
        dayRule.InnerExpression.Should().Be("5");
        dayRule.TimeUnit.Should().Be(RecurlyExTimeUnit.Day);
        dayRule.Spec.Should().Be(RecurlyExRuleSpec.AtInOn);
    ...
    public void TryParse_OnMonday_Success(string expression)
    {
        ...
        var weekRule = recurlyEx.WeekRules().FirstOrDefault() as RecurlyExAtInOnRule;
    ...
    public void TryParse_OnMonth5_Success(string expression)
    {
        ...
        var monthRule = recurlyEx.MonthRules().FirstOrDefault() as RecurlyExAtInOnRule;
    ...
    public void TryParse_At1030_Success(string expression)
    {
        ...
        var minuteRule = recurlyEx.MinuteRules().FirstOrDefault() as RecurlyExAtInOnRule;
        ...
        var hourRule = recurlyEx.HourRules().FirstOrDefault() as RecurlyExAtInOnRule;
        hourRule.Should().NotBeNull();
        hourRule.InnerExpression.Should().Be("10");
        hourRule.TimeUnit.Should().Be(RecurlyExTimeUnit.Hour);
        hourRule.Spec.Should().Be(RecurlyExRuleSpec.AtInOn);
    ...
    public void TryParse_2020Nov_Success(string expression)
    {
        ...
        var yearRule = recurlyEx.YearRules().FirstOrDefault() as RecurlyExAtInOnRule;
        yearRule.Should().NotBeNull();
        yearRule.InnerExpression.Should().Be("2020");
        yearRule.TimeUnit.Should().Be(RecurlyExTimeUnit.Year);
        yearRule.Spec.Should().Be(RecurlyExRuleSpec.AtInOn);
    }
    ...
    public void TryParse_2020Jan11_Success(string expression)
    {
        ...
        var secondRule = recurlyEx.SecondRules().FirstOrDefault() as RecurlyExAtInOnRule;
        secondRule.Should().NotBeNull();
        secondRule.InnerExpression.Should().Be("10");
        secondRule.TimeUnit.Should().Be(RecurlyExTimeUnit.Second);
        secondRule.Spec.Should().Be(RecurlyExRuleSpec.AtInOn);
